...
def frequencies_gammatone_bank(start_band, end_band, norm_freq, channels):
    ...
    centerfrequencies = erbscale_to_hertz(
        np.linspace(start_band, end_band, channels) + norm_erb)
...
class GammatoneFilterbank:
    ...
    def __init__(
        ...
        self.centerfrequencies = frequencies_gammatone_bank(
            startband, endband, normfreq, channels)
